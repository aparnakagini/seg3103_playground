...
class DateTest {
  ...
  void nextDate_tc21() {
    ...
    Date expectedTomorrow = new Date(2020, 2, 29); // Leap year
    assertEquals(expectedTomorrow, today.nextDate());
  }
  ...
  void nextDate_tc22() {
    ...
    Date expectedTomorrow = new Date(2019, 3, 1); // Non-leap year
    assertEquals(expectedTomorrow, today.nextDate());
  }

  @Test
  void nextDate_tc23() {
    Date today = new Date(2000, 2, 29); // Leap year
  ...
  @Test
  void nextDate_tc24() {
    Date today = new Date(1900, 2, 28); // Non-leap year
